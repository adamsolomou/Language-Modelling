    ...
    def fit(self, x, batch_size=64, epochs=1, val_data=None, shuffle=True):
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(epochs):
                ...
                print('Mean perplexity over validation sentences at step %i: %f' %(i, np.mean(valid_perp)))

        return self

    def evaluate(self, x, batch_size=64, verbose=False):
        """
        ...
        verbose : Boolean
            If True, perplexity results for each sentence are printed. 
