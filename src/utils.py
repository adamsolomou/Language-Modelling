...
def dev_step(sentences_batches, lstm, global_step, session, valid_writer, verbose=True):
    """
    ...
    summary_dev_loss = tf.Summary()
    summary_dev_loss.value.add(tag="perplexity/average_perplexity_per_sentence",
